...
class CIFAR10CNN(nn.Module):
    def __init__(self, channel, num_classes, im_size, conv_num, kernel_num=16):
        ...
        if conv_num == 4:
            ...
            self.conv = nn.Sequential(
                nn.Conv2d(channel, 8, kernel_size=3, padding=1),
                nn.BatchNorm2d(8),
                nn.ReLU(),
                nn.MaxPool2d(kernel_size=2, stride=2),
                nn.Conv2d(8, kernel_num, kernel_size=3, padding=1),
            ...
            self.conv = nn.Sequential(
                nn.Conv2d(channel, 4, kernel_size=3, padding=1),
                nn.BatchNorm2d(4),
                nn.ReLU(),
                nn.MaxPool2d(kernel_size=2, stride=2),
            )
